package com.sweet.qianqian.common.tab;
...
import com.sweet.qianqian.common.BadgeView;
import com.sweet.qianqian.common.tab.listener.CustomTabEntity;
import com.sweet.qianqian.common.tab.listener.OnTabSelectListener;
import com.sweet.qianqian.common.tab.utils.FragmentChangeManager;
import com.sweet.qianqian.common.tab.utils.UnreadMsgUtils;
...
//            tv_tab_title.setPadding((int) tabPadding, 0, (int) tabPadding, 0);
    ...
    public void showMsg(int position, int num) {
        ...
        BadgeView tipView = (BadgeView) tabView.findViewById(R.id.rtv_msg_tip);
        if (tipView != null) {
    ...
    public BadgeView getMsgView(int position) {
        if (position >= tabCount) {
            position = tabCount - 1;
        }
        View tabView = tabsContainer.getChildAt(position);
