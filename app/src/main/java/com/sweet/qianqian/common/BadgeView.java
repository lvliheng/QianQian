...
public class BadgeView extends TextView {
    ...
    public BadgeView(Context context,TabWidget tabWidget,int index) {
    	this(context,null);
    	this.context = context;
    	this.tagView = tabWidget;
    	this.index = index;
    }
	...
	private void applyTo(View target,int targetTabIndex) {
